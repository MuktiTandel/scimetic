...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() => controller.isUser.value == false
        ? Scaffold(
                                    ...
                                    itemBuilder:
                                      ...
                                      return listWidget(
                                          onTap: () {
                                            ...
                                            controller.isOverViewTitle.value =
                                                true;
                                            controller.id.value = data.id!;
                                            overViewController.is24Hour.value =
                                                true;
                                            overViewController.isWeek.value =
                                                false;
                                            overViewController.isMonth.value =
                                                false;
                                            overViewController.id.value =
                                                data.id!;
                                            overViewController.isGetData.value =
                                                false;
                                            overViewController
                                          ...
                                          editTap: () {
                                            ...
                                            controller.growspaceNameController
                                                .text = data.name!;
                                            ...
                                            if (data.dayStart!.isNotEmpty) {
                                              ...
                                              controller.dayHourController
                                                  .text = values[0]!;
                                              controller.dayMinuteController
                                                  .text = values[1]!;
                                            }
                                            ...
                                            if (data.nightStart!.isNotEmpty) {
                                              ...
                                              controller.nightHourController
                                                  .text = values1[0]!;
                                              controller.nightMinuteController
                                                  .text = values1[1]!;
                                            }
                                          ...
                                          temperature:
                                              data.climate!.temperature ?? 0.0,
                                          co2: data.climate!.co2 ?? 0.0,
                                          humidity:
                                              data.climate!.humidity ?? 0.0,
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            featureWidget(
                                ...
                                value: "$temperatureValue° С"),
                            SizedBox(
                              height: 15.h,
                            ),
                            featureWidget(
                                title: AppStrings.cO2, value: "$co2Value ppm"),
                          ],
                        ),
                        Expanded(
                            child: SizedBox(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            featureWidget(
                                title: AppStrings.vpd, value: "$vpdValue kPa"),
                          ],
                        ),
                        Expanded(
                            child: SizedBox(
                        ...
                        children: [
                          ...
                          commonTimeTextField(
                              ...
                              onChanged: (value) {
                                if (value.isNotEmpty) {
                                  if (int.parse(value) > 59) {
                                    controller.nightMinuteController.text =
                                        "59";
                                  }
                                }
                              }),
        ...
        child: Column(
          ...
          children: [
            Image.asset(
              ...
              width: 15.w,
              color: color ??
                  (Get.isDarkMode ? Colors.white : AppColors.lightGray1),
            ),
            SizedBox(
              height: 5.h,
            ),
