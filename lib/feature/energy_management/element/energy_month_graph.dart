...
class EnergyMonthGraph extends StatelessWidget {
  const EnergyMonthGraph({
    Key? key,
    required this.minY,
    required this.maxY,
      ...
      child: SfCartesianChart(
        ...
        series: <ChartSeries>[
          SplineAreaSeries<MonthGraphModel, double>(
              ...
              yValueMapper: (MonthGraphModel data,_) => data.y2
          ),
          SplineAreaSeries<MonthGraphModel, double>(
              gradient: LinearGradient(
                  begin: Alignment.topCenter,
          ...
          SplineAreaSeries<MonthGraphModel, double>(
              gradient: LinearGradient(
                  ...
                  colors: [graphColor2, graphColor2.withOpacity(0)]
              ),
              dataSource: dataList,
              xValueMapper: (MonthGraphModel data, _) => data.x,
