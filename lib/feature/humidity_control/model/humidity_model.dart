...
class HumidityModel {
  ...
  factory HumidityModel.fromJson(Map<String, dynamic> json) => HumidityModel(
    dayHumidityRh: json["dayHumidityRH"] != null ? json["dayHumidityRH"].toDouble() : 0,
    dayHumidityRhDeadband: json["dayHumidityRhDeadband"] != null ? json["dayHumidityRhDeadband"].toDouble() : 0,
    nightHumidityRh: json["nightHumidityRh"] != null ? json["nightHumidityRh"].toDouble() : 0,
    nightHumidityRhDeadband: json["nightHumidityRhDeadband"] != null ? json["nightHumidityRhDeadband"].toDouble() : 0,
    dayDehumidityRh: json["dayDehumidityRh"] != null ? json["dayDehumidityRh"].toDouble() : 0,
    nightDehumidityRh: json["nightDehumidityRh"] != null ? json["nightDehumidityRh"].toDouble() : 0,
    dayDehumidityRhDeadband: json["dayDehumidityRhDeadband"] != null ? json["dayDehumidityRhDeadband"].toDouble() : 0,
    nightDehumidityRhDeadband: json["nightDehumidityRhDeadband"] != null ? json["nightDehumidityRhDeadband"].toDouble() : 0,
