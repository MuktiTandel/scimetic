...
class HourGraph1 extends StatefulWidget {
  const HourGraph1({
    Key? key,
    required this.minY,
    required this.maxY,
  ...
  @override
  State<HourGraph1> createState() => _HourGraph1State();
}

class _HourGraph1State extends State<HourGraph1> {
  @override
  Widget build(BuildContext context) {
    return SizedBox(
      height: 150.h,
