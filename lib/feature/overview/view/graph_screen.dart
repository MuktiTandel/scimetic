  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CommonAppbar(
          profileImage: profileController.imageUrl.value != ""
              ? profileController.imageUrl.value
              : (profileController.storeData.getData(StoreData.userImage) == "")
                  ? ""
                  : profileController.storeData.getData(StoreData.userImage) ??
                      "",
          drawerTap: () {
      ...
      body: Obx(() => overviewController.isGetData.value == false
          ? const Center(
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                      ...
                      () => graphWidget(
                          ...
                          hour24Select: () {
                            overviewController.get24HourData(
                                id: overviewController.id.value,
                                identifier:
                                    dashboardController.selectItem.value);
                          ...
                          graph: Obx(() =>
                              overviewController.isClimateData.value == true
                                  ? controller.graph()
                                  : SizedBox(
                                      height: 150.h,
                                    ))),
                    ...
                    growSheetWidget(
                        onTap1: () {
                          overviewController.isEnable.value =
                              !overviewController.isEnable.value;
                        },
                        isEnable: overviewController.isEnable.value,
                        ...
                        genealogyController:
                            overviewController.genealogyController,
                        ...
                        plantedTap: () {
                          if (overviewController.harvestDate.selectedDate!
                            ...
                            overviewController.totalPeriod.value =
                                overviewController.harvestDate.selectedDate!
                                        .difference(overviewController
                                            .plantedDate.selectedDate!)
                                        .inDays +
                                    1;

                            overviewController.currentDay.value = DateTime.now()
                                    .difference(overviewController
                                        .plantedDate.selectedDate!)
                                    .inDays +
                                1;
                            ...
                            final num totalSpent =
                                data.values.reduce((prev, curr) => prev + curr);
                            overviewController
                                .progressValue.value = ((totalSpent /
                                        overviewController.totalPeriod.value) *
                                    100)
                                .ceil()
                                .clamp(0, 100);
                            ...
                            overviewController.resolveAngles(
                                data, overviewController.totalPeriod.value);
                          }
                        },
                        harvestTap: () async {
                          if (overviewController.plantedDate.selectedDate!
                              .toString()
                              .isNotEmpty) {
                            overviewController.progressValue.value = 0;
                    ...
                    if (overviewController.deviceModel.devices != null)
                      deviceOverviewWidget(
                          onTap: () {},
                          switchesOnline: overviewController
                              .deviceModel.devices!.devicesSwitch!.online
                              .toString(),
                          switchesOffline: overviewController
                              .deviceModel.devices!.devicesSwitch!.offline
                              .toString(),
                          sensorOnline: overviewController
                              .deviceModel.devices!.sensor!.online
                              .toString(),
                          sensorOffline: overviewController
                              .deviceModel.devices!.sensor!.offline
                              .toString(),
                          valvesOnline: overviewController
                              .deviceModel.devices!.valve!.online
                              .toString(),
                          valvesOffline: overviewController
