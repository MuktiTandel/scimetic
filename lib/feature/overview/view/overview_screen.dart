...
class _OverviewScreenState extends State<OverviewScreen> {
  ...
  void initState() {
    super.initState();
    print(homeController.roleId.value);
                            ...
                            : Column(
                                children: [
                                  ...
                                  Obx(() => commonGraphWidget(
                                      ...
                                      graph: Obx(() => controller
                                          ...
                                          ? HourGraph(
                                              ...
                                              maxY:
                                                  controller.maxHumidityY.value,
                                              graphColor: AppColors.lightBlue,
                                              dataList:
                                                  controller.humidityDataList,
                                              format: "kW",
                                            )
                                          : SizedBox(
                                              height: 150.h,
                                  ...
                                  Obx(() => commonGraphWidget(
                                      ...
                                      value:
                                          controller.co2Value.value.toString(),
                                    ...
                                    () => commonGraphWidget(
                                        ...
                                        graph: Obx(() => controller
                                            ...
                                            ? HourGraph(
                                                ...
                                                maxY:
                                                    controller.maxLightY.value,
                                                dataList:
                                                    controller.vpdDataList,
                                  ...
                                  Obx(() => commonGraphWidget(
                                      ...
                                      image: AppImages.horizontalMenu,
                                      value:
                                          controller.vpdValue.value.toString(),
                                  ...
                                  growSheetWidget(
                                      ...
                                      plantedDateValue:
                                          controller.plantedDateValue,
                                      harvestDateValue:
                                          controller.harvestDateValue,
                                    ...
                                    () => deviceOverviewWidget(
                                        onTap: () {
                                          dashboardController.isOverView.value =
                                              false;
                                          homeController.isDeviceSetup.value =
                                              true;
                                        ...
                                        sensorOnline:
                                            controller.isGetDevice.value == true
                                                ? controller.deviceModel
                                                    .devices!.sensor!.online
                                                    .toString()
                                                : "0",
                                        sensorOffline:
                                            controller.isGetDevice.value == true
                                                ? controller.deviceModel
                                                    .devices!.sensor!.offline
                                                    .toString()
                                                : "0",
                                        valvesOnline: controller.isGetDevice.value == true
                                            ? controller.deviceModel.devices!.valve!.online.toString()
                                            : "0",
                                        valvesOffline: controller.isGetDevice.value == true ? controller.deviceModel.devices!.valve!.offline.toString() : "0"),
                                  ),
                                  SizedBox(
                                    height: 20.h,
                                  )
